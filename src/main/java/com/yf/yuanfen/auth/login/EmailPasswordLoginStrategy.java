...
public class EmailPasswordLoginStrategy implements LoginStrategy {
    ...
    public EmailPasswordLoginStrategy(UserMapper userMapper, PasswordEncoder passwordEncoder, TokenService tokenService) {
    ...
    public TokenResponse login(LoginRequest request) {
        User user = userMapper.selectByEmail(request.getIdentifier());
