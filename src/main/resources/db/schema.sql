...
CREATE TABLE IF NOT EXISTS `users` (
    ...
    `password_hash` VARCHAR(256)    CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '密码哈希(BCrypt)',
    ...
    `city`          VARCHAR(64)     CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '所在城市',
    `address`       VARCHAR(256)    CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '居住地址',
...
CREATE TABLE IF NOT EXISTS `refresh_tokens` (
    ...
    `token`      VARCHAR(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Refresh Token',
